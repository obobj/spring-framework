...
* Spring MVC com.luban.test.Test: A framework, also known as `MockMvc`, for testing annotated controllers
...
See <<testing.adoc#spring-mvc-test-framework, Spring MVC com.luban.test.Test>> for more details.
